...
FOREIGN = ['تُونُس','تِلِمْسَان','فَرَنْسَا','أُورُوبَّا','لُوِيس','قَشْتَالَة','سِرَقُوسَة',
           'السِّنِغَال','الْفَايْكِنْج','مَلِيلِيَّة','وَرْجِلَان','بَطَلْيَوْس','سَرَقُسْطَة','الْفِيلْم']
MUDAF = ['حَلَقَةِ','مَدِينَةِ','بِلَادِ','جَزِيرَةِ','مَلِكُ','مَلِكِ','سَاحِلِ','نَهْرِ','قَبَائِلِ','وَادِي','جَبَلِ','أَهْلِ','قَصْرِ']
