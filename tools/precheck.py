...
# ⛔⛔ أمرُ المالك 2026-09-21: المصغّرةُ **تُكمِّل** العنوانَ ولا تُطابقه، وتكون مشوّقةً
#    بحيث لا يستطيع المشاهدُ تجاهلَها. والحارسُ مانعٌ لا مستشار، ولا يُحذف من هنا.
import thumbcheck  # noqa: E402
_thumb_problems = thumbcheck.audit(pub)
bad.extend(_thumb_problems)
print("حارسُ المصغّرة: %s" % ("✅ مكمِّلةٌ ومشوّقةٌ ومتمايزة" if not _thumb_problems
                              else "⛔ %d مانع" % len(_thumb_problems)))
